...
import com.example.javaee.dao.GreetingService;
...
public class ArquillianExampleTest {
    ...
    public static WebArchive createDeployment() {
        ...
        .addPackages(true, "com.example.javaee").addAsWebInfResource("beans.xml")
    ...
    @Test
    public void testDao() {
        String greeting = greeter.sayHi("padavan");
        assertTrue("greeting should be nice ", greeting.contains("Hi"));
        List<Measurement> allItems = metricsDao.getAll();
        assertTrue("There should be 1 metric item in the DB", !allItems.isEmpty());
    }
